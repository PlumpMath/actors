...
public class SourceContextTest {
    ...
    public void mustQueueUpOutgoingMessages() {
        ...
        fixture.addOutgoingMessage(Address.fromString("self"), Address.fromString("test1"), "1");
        fixture.addOutgoingMessage(Address.fromString("self:src"), Address.fromString("test2"), "2");
        fixture.addOutgoingMessage(Address.fromString("self:src"), Address.fromString("test3"), "3");
        ...
        assertEquals(Address.fromString("self:src"), outgoingMsgsView.get(1).getSource());
        ...
        assertEquals(Address.fromString("self:src"), outgoingMsgsView.get(2).getSource());
    ...
    public void mustDrainOutgoingMessages() {
        ...
        assertEquals(Address.fromString("self:src"), outgoingMsgs.get(1).getSource());
        assertEquals(Address.fromString("test2"), outgoingMsgs.get(1).getDestination());
        assertEquals("2", outgoingMsgs.get(1).getMessage());

        assertEquals(Address.fromString("self:src"), outgoingMsgs.get(2).getSource());
    ...
    public void mustConvertToNormalContext() {
        fixture.addOutgoingMessage(Address.of("self"), Address.fromString("test1"), "1");
        ...
        assertEquals(Address.of("self"), outgoingMsgsView.get(0).getSource());
